...
pub const HEAD_WIDTH_WHITE: f32 = SPACE * 1.37;
pub const HEAD_WIDTH_WIDE: f32 = SPACE * 1.65;
pub const HEAD_SPACER: f32 = SPACE * 0.2;
pub const HEADS_DIAGONAL_ADJUST: f32 = SPACE * 0.3;
...
pub const LYRICS_OFF_AXIS: f32 = 4.0;
...
pub const CHORD_FONT_FIGURE_SCALE: f32 = 0.05;
...
pub const TIE_FROM_WIDTH: f32 = SPACE * 0.3;
pub const TIE_TO_WIDTH: f32 = SPACE * 0.3;
pub const TIE_SPACE: f32 = SPACE * 1.4;
pub const TIE_SPACE_HALF: f32 = TIE_SPACE * 0.5;

pub const TIE_HEIGHT: f32 = SPACE * 0.6;
pub const TIE_THICKNESS: f32 = SPACE * 0.15;
